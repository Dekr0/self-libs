...
"""
#w#w: labeled as weather and contains target words about weather (TP)
#wn: labeled as not and contains target words about weather (FP)
n#w: labeled as weather and not contains target words about weather (FN)
nn: labeled as not and not contains target words about weather (TN)
"""
...
class ClassifyByTarget(C274):
    ...
    def print_confusion_matrix(self):
        ...
        print("   Predict |{}".format("Label ".rjust(15)))
        print("{}+{}".format("-"*11, "-"*22))
        print("           |   #weather        not")
