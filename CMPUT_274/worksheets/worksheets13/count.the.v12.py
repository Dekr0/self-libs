...
# To do for confusion matrix
# Modify classify_by_words and process_input_file
# Label, target words
...
class ClassifyByTarget(C274):
    ...
    def print_confusion_matrix(self):
        print(" Confusion Matrix ".center(34, "-"))
        print("{}Predict |{}".format(" "*3, "Label".center(24)))
        print("{}{}{}".format("-"*11, "+", "-"*22))
        print("           |   #weather        not")
...
class TrainingInstance(C274):
    def __init__(self):
        ...
        self.label = "N/A"      # Class, given by oracle
        self.words = []         # Bag of words
        self.cls = ""     # Class, by classifier
        self.explain = ""       # Explanation for classification
        self.experiments = dict()   # Previous classifier runs
...
class TrainingSet(C274):
    def __init__(self):
        ...
        self.inObjHash = []     # Parsed lines, in dictionary/hash, stores ti (Training Instance)
        return
